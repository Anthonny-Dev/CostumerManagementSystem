...
public class ListagemView {
    ...
    public static VBox createPane() {
        ...
        TableColumn<Produtos, String> nomeProdutoCol = new TableColumn<>("Produto");
        nomeProdutoCol.setCellValueFactory(new PropertyValueFactory<>("nomeProduto"));
        ...
        TableColumn<Produtos, Integer> valorCol = new TableColumn<>("Valor");
       ...
       atualizarBtn.setOnAction(e -> {
            ...
            List<Account> lista = controller.listarClientes();
